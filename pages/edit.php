<ul class="main-menu">
    ...
    <li><a href="edit" class="active"><span class="glyphicon glyphicon-cog"></span>Settings</a></li>
</ul>
    ...
    <div class="row">
        ...
        <div
            ...
            <div class="panel panel-info">
                <div class="panel-own">
                    <h3 class="panel-title">Gina Beuk</h3>
                </div>
                <div class="panel-body">
                        ...
                        <div class=" col-md-9 col-lg-9 ">
                            <table class="table table-user-information">
                                ...
                                <tr>
                                    ...
                                    <td><a href="#">@GinaBeuk</a></td>
                                </tr>
                                <tr>
                                    <td>Facebook</td>
                                    <td><a href="#">fb.com/GinaBeuk</a></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                    ...
                    <div class="panel-footer">
                     <span class="pull-right">
                            <a href="#"
                               class="btn btn-orange"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                        </span>
